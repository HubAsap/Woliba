...
import 'SmokingStatusScreen.dart';

class DrinkingStatusScreen extends StatefulWidget {
  const DrinkingStatusScreen({super.key});

  @override
  State<DrinkingStatusScreen> createState() => _DrinkingStatusScreenState();
}

class _DrinkingStatusScreenState extends State<DrinkingStatusScreen> {
  String interest = "Yes";
          ...
          child: CustomButtonWidget(
              ...
              onTap: (){
                Navigator.of(context)
                  ...
                  return const SmokingStatusScreen();
                }));
              },
