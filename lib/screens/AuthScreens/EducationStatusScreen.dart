...
import 'package:woliba/screens/AuthScreens/ReligiousBeliefScreen.dart';
...
class _EducationStatusScreenState extends State<EducationStatusScreen> {
  String interest = "High school";
  final List<String> options = ["High school", "Undergrad", "Postgrad", "Prefer Not to Say"];
          ...
          children: [
            ...
            const Padding(
              ...
              child: CustomTextWidget(
                text: "What's the highest level you attained?",
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            color: interest == "High school" ? ColorLibrary.primaryColor : ColorLibrary.bgColor2,
                          ...
                          child: Padding(
                            ...
                            child: CustomTextWidget(
                              text: options[0],
                              foreColor: interest == "High school" ? ColorLibrary.foreColorLight : ColorLibrary.foreColorDark,
                              fontSize: 11,
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          height: 40,
                          decoration: BoxDecoration(
                            color: interest == "Undergrad" ? ColorLibrary.primaryColor : ColorLibrary.bgColor2,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Padding(
                            padding: const EdgeInsets.fromLTRB(10, 14, 10, 14),
                            child: CustomTextWidget(
                              text: options[1],
                              foreColor: interest == "Undergrad" ? ColorLibrary.foreColorLight : ColorLibrary.foreColorDark,
                              fontSize: 11,
                              fontWeight: FontWeight.normal,
                              fontFamily: "",
                              textAlign: TextAlign.center,
                    ...
                    Padding(
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          height: 40,
                          decoration: BoxDecoration(
                            color: interest == "Postgrad" ? ColorLibrary.primaryColor : ColorLibrary.bgColor2,
                            borderRadius: BorderRadius.circular(10),
                          ),
                          child: Padding(
                            padding: const EdgeInsets.fromLTRB(10, 14, 10, 14),
                            child: CustomTextWidget(
                              text: options[2],
                              foreColor: interest == "Postgrad" ? ColorLibrary.foreColorLight : ColorLibrary.foreColorDark,
                              fontSize: 11,
                              fontWeight: FontWeight.normal,
                              fontFamily: "",
                              textAlign: TextAlign.center,
          ...
          child: CustomButtonWidget(
              ...
              onTap: (){
                Navigator.of(context)
                  ...
                  return const ReligiousBeliefScreen();
                }));
              },
