...
import 'package:woliba/screens/AuthScreens/DrugUsageStatusScreen.dart';
import '../../Repo/ColorLibrary.dart';
import '../../widgets/ButtonWidget.dart';
import '../../widgets/TextWidget.dart';

class SmokingWeedStatusScreen extends StatefulWidget {
  const SmokingWeedStatusScreen({super.key});

  @override
  State<SmokingWeedStatusScreen> createState() => _SmokingWeedStatusScreenState();
}

class _SmokingWeedStatusScreenState extends State<SmokingWeedStatusScreen> {
  String interest = "Yes";
          ...
          child: CustomButtonWidget(
              ...
              onTap: (){
                Navigator.of(context)
                  ...
                  return const DrugUsageStatusScreen();
                }));
              },
